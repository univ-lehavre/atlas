  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          Pour accéder à mes demandes, je vais m'authentifier. Cette action
          déposera un cookie nécessaire au bon fonctionnement du site dans votre
          navigateur. Pour le supprimer après l'authentification, il suffira que
          je me déconnecte.
        </p>
        <form
          method="post"
        ...
        >
          ...
          <input
            ...
            bind:value={email}
          />
          <button type="submit" class="btn btn-primary {disabledSubmit}">
        ...
        {#if showSuccessAlert}
          ...
          >
            <span>
              Un courriel d'authentification vous a été envoyé. Veuillez
