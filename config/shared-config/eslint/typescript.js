 ...
 * @property {'packages' | 'cli' | 'services'} [architectureCategory] - Monorepo category for architecture enforcement rules
 */
            ...
            rules: {
              ...
              "no-restricted-syntax": [
                "error",
                {
                  ...
                  message:
                    "process.stdout belongs in cli/ — packages/ must be side-effect free.",
                },
                {
                  selector:
                    "MemberExpression[object.name='process'][property.name='stderr']",
                  message:
                    "process.stderr belongs in cli/ — packages/ must be side-effect free.",
                },
              ],
            },
          },
                  ...
                  patterns: [
                    {
                      ...
                      message: "services/ must not import CLI packages.",
                    },
                  ],
                },
              ],
