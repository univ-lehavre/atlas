...
[@univ-lehavre/atlas-redcap-api](../README.md) / InstrumentName

# Type Alias: InstrumentName

> **InstrumentName** = `string` & `Brand.Brand`\<`"InstrumentName"`\>

Defined in: [packages/redcap-api/src/brands.ts:244](https://github.com/univ-lehavre/atlas/blob/efca797d113c12556abf22a7fdb97dae8aa62ade/packages/redcap-api/src/brands.ts#L244)
