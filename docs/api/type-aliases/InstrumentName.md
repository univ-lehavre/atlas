...
[@univ-lehavre/atlas-redcap-api](../index.md) / InstrumentName

# Type Alias: InstrumentName

> **InstrumentName** = `string` & `Brand.Brand`\<`"InstrumentName"`\>

Defined in: [packages/redcap-api/src/brands.ts:244](https://github.com/univ-lehavre/atlas/blob/9f020e0b970df818d41e1532805b25c2cea7c1b7/packages/redcap-api/src/brands.ts#L244)
