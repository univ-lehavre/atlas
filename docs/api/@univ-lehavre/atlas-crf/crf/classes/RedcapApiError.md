...
Defined in: [packages/crf/src/redcap/errors.ts:28](https://github.com/univ-lehavre/atlas/blob/48acc16c89a79209d3be1763a73e3e9607aa38aa/packages/crf/src/redcap/errors.ts#L28)
...
`Data.TaggedError('RedcapApiError')<{ readonly message: string; readonly status?: number; }>.constructor`

## Properties

### \_tag

> `readonly` **\_tag**: `"RedcapApiError"`

Defined in: node\_modules/.pnpm/effect@3.19.15/node\_modules/effect/dist/dts/Data.d.ts:611

#### Inherited from

`Data.TaggedError('RedcapApiError')._tag`

***

### \[ChannelTypeId\]

> `readonly` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `RedcapApiError`, `unknown`, `never`, `unknown`, `never`\>

Defined in: node\_modules/.pnpm/effect@3.19.15/node\_modules/effect/dist/dts/Cause.d.ts:285

#### Inherited from

`Data.TaggedError('RedcapApiError').[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` **\[EffectTypeId\]**: `VarianceStruct`\<`never`, `RedcapApiError`, `never`\>

Defined in: node\_modules/.pnpm/effect@3.19.15/node\_modules/effect/dist/dts/Cause.d.ts:282

#### Inherited from

`Data.TaggedError('RedcapApiError').[EffectTypeId]`

***

### \[SinkTypeId\]

> `readonly` **\[SinkTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `RedcapApiError`, `never`\>

Defined in: node\_modules/.pnpm/effect@3.19.15/node\_modules/effect/dist/dts/Cause.d.ts:284

#### Inherited from

`Data.TaggedError('RedcapApiError').[SinkTypeId]`

***

### \[StreamTypeId\]

> `readonly` **\[StreamTypeId\]**: `VarianceStruct`\<`never`, `RedcapApiError`, `never`\>

Defined in: node\_modules/.pnpm/effect@3.19.15/node\_modules/effect/dist/dts/Cause.d.ts:283

#### Inherited from

`Data.TaggedError('RedcapApiError').[StreamTypeId]`
...
`Data.TaggedError('RedcapApiError').cause`
...
`Data.TaggedError('RedcapApiError').name`
...
`Data.TaggedError('RedcapApiError').stack`
...
Defined in: [packages/crf/src/redcap/errors.ts:30](https://github.com/univ-lehavre/atlas/blob/48acc16c89a79209d3be1763a73e3e9607aa38aa/packages/crf/src/redcap/errors.ts#L30)

#### Inherited from

`Data.TaggedError('RedcapApiError').status`

## Methods

### \[iterator\]()

> **\[iterator\]**(): `EffectGenerator`\<`Effect`\<`never`, `RedcapApiError`, `never`\>\>

Defined in: node\_modules/.pnpm/effect@3.19.15/node\_modules/effect/dist/dts/Cause.d.ts:286

#### Returns

`EffectGenerator`\<`Effect`\<`never`, `RedcapApiError`, `never`\>\>

#### Inherited from

`Data.TaggedError('RedcapApiError').[iterator]`
...
`Data.TaggedError('RedcapApiError').[NodeInspectSymbol]`
...
`Data.TaggedError('RedcapApiError').pipe`
...
`Data.TaggedError('RedcapApiError').toJSON`
...
`Data.TaggedError('RedcapApiError').toString`
