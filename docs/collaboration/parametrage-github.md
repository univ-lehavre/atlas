...
fichiers sous [`.github/`](../../.github/) décrivent la configuration en
...
| [`workflows/*.yml`](../../.github/workflows/)                        | Workflows GitHub Actions (CI, sécurité, release, docs) — voir [Pipeline CI](../quality/ci-pipeline.md) |

### Propriété du code (CODEOWNERS)

[`CODEOWNERS`](../../.github/CODEOWNERS) associe des chemins à des
...
[`dependabot.yml`](../../.github/dependabot.yml) maintient deux
...
par [`dependabot-auto-merge.yml`](../../.github/workflows/dependabot-auto-merge.yml)
...
- **Pull request obligatoire** — pas de push direct sur `main`. C'est
  ...
  tout commit/push direct sur `main` (voir [lefthook.yml](../../lefthook.yml)).
...
- **Vérifications de statut requises** — la PR ne peut fusionner que si la
  ...
  `dependency-review.yml`). Voir [Pipeline CI](../quality/ci-pipeline.md).
...
le [workflow de contribution](./workflow.md#8-merge).
...
local (voir [environnement local](./environnement-local.md#variables-denvironnement-et-secrets)).

| Secret        | Utilisé par                                          | Rôle                                                                        |
| ------------- | ---------------------------------------------------- | --------------------------------------------------------------------------- |
| `TURBO_TOKEN` | [`ci.yml`](../../.github/workflows/ci.yml)           | Cache distribué Turborepo, pour accélérer la CI                             |
| `NPM_TOKEN`   | [`release.yml`](../../.github/workflows/release.yml) | Authentification au registre npmjs à la publication                         |
| `PAT_TOKEN`   | [`release.yml`](../../.github/workflows/release.yml) | Jeton personnel permettant à Changesets d'ouvrir la PR « Version Packages » |
...
voir [ADR 0017](../decisions/0017-releases-npm-oidc-deux-registres.md).
...
[`docs.yml`](../../.github/workflows/docs.yml) à chaque push sur `main`.
...
- **CodeQL** — analyse statique de sécurité ([`codeql.yml`](../../.github/workflows/codeql.yml)) ;
