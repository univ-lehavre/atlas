...
| [`atlas-dashboard`](../../apps/atlas-dashboard/README.md)     | Tableau de bord interne — vue d'ensemble santé du monorepo (CI, couverture, releases).   | [`atlas-shared-config`](../../config/shared-config/README.md), [`atlas-stats`](../../packages/atlas-stats/README.md), [`atlas-sveltekit-csp`](../../packages/sveltekit-csp/README.md)                                                                                                                                                                                                                                                                                                                                                                                | —            |
...
| Paquet                                      | Rôle                                       | Dépend de                                                                                                                | Consommé par                               |
| ------------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------ |
| [`atlas-crf`](../../services/crf/README.md) | CRF Service - HTTP microservice for REDCap | [`atlas-crf-client`](../../packages/crf-client/README.md), [`atlas-shared-config`](../../config/shared-config/README.md) | [`atlas-crf-cli`](../../cli/crf/README.md) |
...
| [`atlas-crf-logs`](../../packages/crf-logs/README.md)                         | Clinical research form (CRF / REDCap) audit log fetching, enrichment and rolling-window analytics                             | [`atlas-shared-config`](../../config/shared-config/README.md)                                                                                                                                                                                                                  | [`atlas-crf-dashboard`](../../apps/crf-dashboard/README.md), [`atlas-crf-stats-cli`](../../cli/crf-stats/README.md)                                                                                                                                                                                                                                                                                                                          |
...
| [`atlas-crf-openapi`](../../cli/crf-openapi/README.md)                     | Clinical research form (CRF / REDCap) source analysis, OpenAPI spec extraction, and API documentation tools | [`atlas-crf-core`](../../packages/crf-core/README.md), [`atlas-shared-config`](../../config/shared-config/README.md)                                                                                                                                                                                                                          | —                                                                                                                                                         |
