...
L'encart ci-dessous résume l'effort de documentation **dans le code lui-même**
(commentaires structurés). Sa **densité de documentation** est le rapport entre
le nombre de blocs de commentaires _TSDoc_ — la convention qui documente une
fonction ou une constante juste au-dessus de sa déclaration — et la **surface
exportée** du code, c'est-à-dire le nombre de fonctions et de constantes
publiques. Exprimée en pourcentage, elle indique « combien d'éléments publics
portent un bloc de documentation » : 100 % signifierait un bloc par élément. Elle
peut **dépasser 100 %** parce qu'un même fichier peut porter des blocs qui ne se
rattachent pas à une fonction ou une constante exportée (commentaire de module,
documentation d'un type), comptés au numérateur sans entrer dans la surface du
dénominateur. C'est donc un indicateur de **couverture documentaire**, pas un
taux borné à 100 %.

<DocBadge client:load />
...
occurrence, ou pointé vers le [glossaire](/atlas/glossary/) qui regroupe les
...
→ [ADR 0013 — Documentation pour public non-expert, en français](/atlas/decisions/0013-documentation-public-non-expert-fr/)
...
profondeur ([docs/quality/tests.md](/atlas/quality/tests/)) ; un test qui s'en écarte
...
→ [ADR 0025 — Documentation à plusieurs niveaux (surface, profondeur, inline)](/atlas/decisions/0025-documentation-multi-niveaux/)
...
→ [ADR 0012 — Neutralisation du framing institutionnel](/atlas/decisions/0012-neutralisation-framing-institutionnel/)
...
| -------------------------------------------------------------------- | ------------------------ |
| [0012](/atlas/decisions/0012-neutralisation-framing-institutionnel/) | Ton et framing           |
| [0013](/atlas/decisions/0013-documentation-public-non-expert-fr/)    | Langue et public         |
| [0025](/atlas/decisions/0025-documentation-multi-niveaux/)           | Niveaux de documentation |
