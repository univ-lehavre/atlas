...
| Paquet                                       | Rôle                                                        | Dépend de                                                                                                                                                                                  | Consommé par                                |
| -------------------------------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------- |
| [`atlas-crf`](/atlas/packages/services/crf/) | CRF Service - HTTP microservice for complex reporting forms | [`atlas-crf-client`](/atlas/packages/packages/crf-client/), [`atlas-effect-socle`](/atlas/packages/packages/effect-socle/), [`atlas-shared-config`](/atlas/packages/config/shared-config/) | [`atlas-crf-cli`](/atlas/packages/cli/crf/) |
