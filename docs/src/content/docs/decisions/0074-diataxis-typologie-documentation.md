...
| `plans/2026-06-11-topologie-depots-cluster-atlas.md` | explanation | Décision et plan transverse — large part discursive sur le _pourquoi_.             | **Scindée** (fait) : décision → [ADR 0077](/atlas/decisions/0077-topologie-deux-depots-cluster-atlas/) ; feuille de route conservée (how-to). |
