# 0002 — Monorepo organisé en 8 catégories
...
demande un ajout explicite dans le script (voir [ADR 0019](0019-derogations-workspace-audit.md))
...
- Voir [docs/architecture/monorepo.md](../architecture/monorepo.md)
