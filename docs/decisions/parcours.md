...
[l'index](./README.md). Pour le _quand ouvrir un ADR_, voir la fin de l'index.

> **Par où commencer ?** Si tu ne lis que trois décisions, lis
> [0002](0002-monorepo-huit-categories.md) (comment le dépôt est organisé),
> [0035](0035-depot-generaliste-ouvert.md) (ce que le dépôt cherche à être) et
> [0028](0028-documentation-verifiable.md) (comment la documentation reste fiable).
...
- [0035 — Dépôt généraliste ouvert](0035-depot-generaliste-ouvert.md) : la
  règle-chapeau. Atlas est généraliste et ouvert ; tout y reste neutre de
  domaine, de marque et d'établissement.
- [0031 — Outil générique open-source](0031-outil-generique-open-source.md) :
  l'outil est multi-tenant, pensé pour la contribution inter-établissements.
- [0012 — Neutralisation du framing institutionnel](0012-neutralisation-framing-institutionnel.md) :
...
- [0002 — Monorepo en 8 catégories](0002-monorepo-huit-categories.md) : la
  colonne vertébrale — chaque sous-projet a une catégorie et des règles propres.
- [0008 — CLIs thins, logique dans `packages/`](0008-clis-thins-logique-dans-packages.md) :
  où vit la logique métier.
- [0009 — `atlas` source canonique vs `amarre`](0009-atlas-source-canonique-amarre.md) :
  l'articulation entre le dépôt et une app standalone.
- [0011 — Paquets internes `private`](0011-paquets-internes-private.md) et
  [0022 — Convention de nommage `atlas-`](0022-naming-convention.md) : ce qui est
  publié, et sous quel nom.
- [0003 — `logos` splitté assets + CLI](0003-logos-split-assets-cli.md) : un
...
- [0005 — Effect pour la programmation fonctionnelle](0005-effect-pour-la-pf.md) :
  le paradigme du code métier.
- [0006 — SvelteKit, Hono, Bootstrap](0006-sveltekit-hono-bootstrap.md) : le
  socle applicatif.
- [0007 — REDCap et Appwrite](0007-redcap-appwrite-plateformes.md) : les
  plateformes externes intégrées.
- [0010 — `node-appwrite` SDK 25.x](0010-node-appwrite-sdk-25.md),
  [0020 — Lint Svelte strict](0020-svelte-eslint-strict.md),
  [0024 — Ranges `~` sur les paquets publiables](0024-ranges-deps-publiables-tilde.md) :
  des contraintes de versions assumées.
- [0023 — `storybook:build` cassé en amont](0023-storybook-build-casse-amont.md) :
...
- [0001 — DevSecOps périmètre repo complet](0001-devsecops-perimetre-repo-sine-die.md) :
  l'ambition de couverture, et ce qui est reporté.
- [0014 — Conventional Commits](0014-conventional-commits-scopes-restreints.md),
  [0015 — Hooks Git via lefthook](0015-hooks-git-lefthook-jamais-bypass.md),
  [0016 — Branch protection sur `main`](0016-branch-protection-main.md) : la
  discipline de contribution, jamais contournée.
- [0034 — CI adaptative par chemin](0034-ci-adaptative-par-chemin.md) : comment
  la CI s'allège sans casser la branch protection.
- [0017 — Releases OIDC sur deux registres](0017-releases-npm-oidc-deux-registres.md) :
  la publication signée.
- [0018 — SLA de remédiation des findings](0018-sla-remediation-findings.md),
  [0027 — Security champion (vacant)](0027-security-champion.md) : la posture de
  réponse sécurité.
- [0019 — Dérogations au workspace audit](0019-derogations-workspace-audit.md) :
...
- [0013 — Documentation FR pour public non-expert](0013-documentation-public-non-expert-fr.md) :
  la langue et le public.
- [0025 — Documentation à plusieurs niveaux](0025-documentation-multi-niveaux.md) :
  surface, profondeur, inline.
- [0028 — Documentation vérifiable](0028-documentation-verifiable.md) : la doc
  est un miroir contrôlable ; toute dérive casse la CI.
- [0032 — KPI : généré déterministe vs snapshot](0032-kpi-determinisme-vs-snapshot.md) :
...
- [0029 — Architecture V1 du pipeline](0029-architecture-pipeline-collaborations.md) :
  la plateforme DataOps et le contrat Parquet.
- [0033 — Contrat d'interface application ↔ cluster](0033-contrat-interface-cluster.md) :
...
- [0026 — Périmètre RGPD hors dépôt](0026-rgpd-perimetre.md) : ce que le dépôt ne
  décide pas.
- [0030 — Profilage de collaborations : gate RGPD](0030-rgpd-profilage-collaborations.md) :
...
- [0004 — Volumes anonymes pour `sillage-sandbox`](0004-volumes-anonymes-sillage-sandbox.md) :
  un choix d'isolation spécifique.
- [0021 — Politique de dépendances des sandboxes](0021-sandbox-deps-policy.md) :
  des règles assouplies là où le risque est contenu.

> Plusieurs ADR apparaissent dans plus d'un thème (par exemple
> [0031](0031-outil-generique-open-source.md) touche à la vocation _et_ au RGPD,
> [0030](0030-rgpd-profilage-collaborations.md) au pipeline _et_ à la
