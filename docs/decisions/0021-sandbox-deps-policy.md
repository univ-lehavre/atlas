# 0021 — Politique de dépendances pour les sandboxes
...
2. **Ne doivent PAS dépendre** de :
   ...
   - **Un autre `sandbox/*`** au niveau **npm** (`dependencies` ou
     ...
     npm.
3. **Marqués `private: true`** (cf. [ADR 0011](0011-paquets-internes-private.md)) —
...
[`docs/architecture/monorepo.md`](../architecture/monorepo.md).
