# 0031 — Outil générique open-source : contribution inter-établissements

## Contexte

Le pipeline de recommandation de collaborations
([ADR 0029](0029-architecture-pipeline-collaborations.md)) a d'abord été pensé
...
- la documentation vise un **public non-expert** et **neutralise le framing
  institutionnel** ([ADR 0013](0013-documentation-public-non-expert-fr.md),
  [ADR 0012](0012-neutralisation-framing-institutionnel.md)) ;
- les paquets sont **publiés** (npm OIDC,
  [ADR 0017](0017-releases-npm-oidc-deux-registres.md)) sous un nommage
  **générique sans marque** ([ADR 0022](0022-naming-convention.md), convention
...
- le traitement RGPD est **multi-tenant** : chaque établissement exploite sa
  ...
  ([ADR 0030](0030-rgpd-profilage-collaborations.md)), et l'utilisateur **déclare
...
- **Aucun couplage institutionnel dans le code.** Pas d'identifiant
  ...
  [ADR 0022](0022-naming-convention.md) (pas de marque dans les identifiants) et
  [ADR 0012](0012-neutralisation-framing-institutionnel.md).
- **Multi-tenant by-design.** Une instance = un établissement responsable de
  traitement (cf. [ADR 0030](0030-rgpd-profilage-collaborations.md)). Le code ne
...
- **Le soin DevSecOps est une fonctionnalité, pas un luxe.** CI, tests, audits,
  documentation vérifiable ([ADR 0028](0028-documentation-verifiable.md)),
...
[ADR 0012](0012-neutralisation-framing-institutionnel.md),
[ADR 0013](0013-documentation-public-non-expert-fr.md) et
[ADR 0022](0022-naming-convention.md) sans les remplacer ; cadre le modèle
multi-tenant de [ADR 0030](0030-rgpd-profilage-collaborations.md).
...
[ADR 0030](0030-rgpd-profilage-collaborations.md)) — l'outil ne dispense personne
de sa conformité.
...
- La neutralité de framing ([ADR 0012](0012-neutralisation-framing-institutionnel.md))
  et le nommage générique ([ADR 0022](0022-naming-convention.md)) restent les
