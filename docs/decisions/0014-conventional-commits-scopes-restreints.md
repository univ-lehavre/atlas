# 0014 — Conventional Commits, scopes restreints
...
[ADR 0015](0015-hooks-git-lefthook-jamais-bypass.md)).
...
- Le README mentionne la convention et pointe vers
  [docs/collaboration/workflow.md](../collaboration/workflow.md) pour
  les détails.
- Voir [ADR 0015](0015-hooks-git-lefthook-jamais-bypass.md) pour la
