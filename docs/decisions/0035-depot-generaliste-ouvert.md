# 0035 — Dépôt généraliste ouvert : neutralité de domaine pour la contribution
...
cette vocation par fragments : [0012](0012-neutralisation-framing-institutionnel.md)
neutralise le framing institutionnel, [0013](0013-documentation-public-non-expert-fr.md)
vise un public non-expert, [0022](0022-naming-convention.md) bannit les marques
des identifiants, [0031](0031-outil-generique-open-source.md) acte l'outil
...
Cette règle **chapeaute** [0012](0012-neutralisation-framing-institutionnel.md),
[0013](0013-documentation-public-non-expert-fr.md),
[0022](0022-naming-convention.md) et [0031](0031-outil-generique-open-source.md) :
...
1. **Pas de marque ni d'organisme dans un identifiant.** Aucun nom de marque
   ...
   _(Prolonge [0022](0022-naming-convention.md) et
   [0031](0031-outil-generique-open-source.md).)_
...
3. **Anglais standard et accessible pour le code.** Les identifiants, les
   ...
   [0013](0013-documentation-public-non-expert-fr.md) ; l'anglais concerne le
   **code** et sa référence dérivée, cf.
   [0028](0028-documentation-verifiable.md).)_
...
4. **Les ADR ne décident que pour le dépôt de code.** Un ADR acte des choix
   **techniques internes au dépôt** (architecture, conventions, outillage). Il ne
   ...
   [0030](0030-rgpd-profilage-collaborations.md) et
   [0031](0031-outil-generique-open-source.md).)_

## Statut

Accepted (2026-06-03). Fédère [0012](0012-neutralisation-framing-institutionnel.md),
[0013](0013-documentation-public-non-expert-fr.md),
[0022](0022-naming-convention.md) et [0031](0031-outil-generique-open-source.md)
...
- Le **nommage** suit [0022](0022-naming-convention.md) ; le **framing**,
  [0012](0012-neutralisation-framing-institutionnel.md). Cet ADR en est la
