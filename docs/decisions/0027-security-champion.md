...
[politique de SLA de remédiation](0018-sla-remediation-findings.md) n'a
...
- **Disponibilité** : peut tenir le SLA de [ADR 0018](0018-sla-remediation-findings.md)
...
- L'arrivée d'un second contributeur durable (cf. Phase 5.2 du tableau
  sine die de [ADR 0001](0001-devsecops-perimetre-repo-sine-die.md))
  rouvre cette décision pour attribuer le rôle.
- Le SLA de [ADR 0018](0018-sla-remediation-findings.md) reste la
