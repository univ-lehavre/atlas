# 0032 — KPI documentés : généré déterministe (diff-checké) vs snapshot (append-only)

## Contexte

L'[ADR 0028](0028-documentation-verifiable.md) a posé un modèle anti-dérive
...
nombre de `TODO(owner, date)`, dérogations [ADR 0019](0019-derogations-workspace-audit.md),
...
- Une PR qui modifie l'historique régénère naturellement les périodes concernées
  **dans la même PR** (déclencheur de mise à jour, [ADR 0025](0025-documentation-multi-niveaux.md)).
...
Accepted (2026-06-02). Étend [ADR 0028](0028-documentation-verifiable.md)
