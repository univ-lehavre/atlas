# 0028 — Documentation vérifiable : un miroir contrôlable du code

## Contexte

La politique de documentation du monorepo est posée par trois ADR :
[0013](0013-documentation-public-non-expert-fr.md) (français, public
non-expert, termes définis), [0012](0012-neutralisation-framing-institutionnel.md)
(ton factuel, pas de registre promotionnel) et
[0025](0025-documentation-multi-niveaux.md) (trois niveaux : surface,
...
- **La structure _spécifique_ du code n'était lisible nulle part.** La
  ...
  [`architecture/monorepo`](../architecture/monorepo.md), mais aucune page ne
...
Ce principe **étend** [0013](0013-documentation-public-non-expert-fr.md) /
[0012](0012-neutralisation-framing-institutionnel.md) /
[0025](0025-documentation-multi-niveaux.md) (il ne les remplace pas) avec la
dimension _vérifiable / anti-dérive_.

### Ce qui est généré (factuel)

- **La carte des paquets** — [`architecture/packages`](../architecture/packages.md)
...
[ADR 0013](0013-documentation-public-non-expert-fr.md) (qui veut du français),
...
[ADR 0025](0025-documentation-multi-niveaux.md). Le reste de la documentation
reste français.

## Statut

Accepted (2026-06-01). Complète [0013](0013-documentation-public-non-expert-fr.md),
[0012](0012-neutralisation-framing-institutionnel.md) et
[0025](0025-documentation-multi-niveaux.md) sans les remplacer.
...
([`architecture/comprendre-le-code`](../architecture/comprendre-le-code.md)).
...
- La plupart des README de paquets sont **rédigés en anglais**, alors que
  [ADR 0013](0013-documentation-public-non-expert-fr.md) demande le français.
...
- Toute PR qui modifie un `package.json`, un README ou une page docs régénère
  ...
  [ADR 0025](0025-documentation-multi-niveaux.md), déclencheur de mise à jour).
