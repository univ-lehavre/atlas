# 0023 — `storybook:build` cassé en amont (Storybook 10.4 / Svelte 5.55 / rolldown)
...
[plan de résorption 2026-05-30](../plans/2026-05-30-resorption.md) ajoute
...
disponible. Item sine die (cf. [ADR 0001](0001-devsecops-perimetre-repo-sine-die.md)).
