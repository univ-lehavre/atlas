...
[ADR 0013](0013-documentation-public-non-expert-fr.md) a déjà tranché la
...
- **Audience** : non-expert (cf. [ADR 0013](0013-documentation-public-non-expert-fr.md)).
...
- **Contenu** : ce que fait le composant, à quoi il sert, comment il
  ...
  [`docs/glossary.md`](../glossary.md) (règle héritée de 0013). Les
...
(cf. [ADR 0002](0002-monorepo-huit-categories.md)) → paquet →
...
Accepted (2026-06-01). Complète [ADR 0013](0013-documentation-public-non-expert-fr.md)
...
- Le _pourquoi_ durable d'un choix de bibliothèque ou d'architecture va
  en ADR, pas en commentaire inline (cf. [README ADR](README.md)).
