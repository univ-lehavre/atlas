...
> décisionnel : [ADR 0013](../decisions/0013-documentation-public-non-expert-fr.md),
> [ADR 0012](../decisions/0012-neutralisation-framing-institutionnel.md),
> [ADR 0025](../decisions/0025-documentation-multi-niveaux.md). Ce plan introduit
...
[architecture/monorepo.md](../architecture/monorepo.md) décrit les 8 catégories,
...
[documentation.md](../quality/documentation.md)).
...
- **Règles bloquantes.** README présent (paquet publiable) ; titre H1 ; paragraphe
  ...
  [documentation.md](../quality/documentation.md) est actuellement orpheline.
...
- **But.** [data-flow.md](../architecture/data-flow.md) : décrire le parcours d'une
...
- **[ci-pipeline.md](../quality/ci-pipeline.md)** : définir _lint_, _typecheck_,
  _test_, _audit_ (et le détail par sous-commande).
- **[tests.md](../quality/tests.md)** : introduire Docker, Appwrite, REDCap avant le
  tableau, avec renvoi au glossaire.
- **[code-style.md](../quality/code-style.md)** : définir _Git_.
- **[hooks.md](../quality/hooks.md)** : définir _commit_, _push_, _pull request_,
  _hook_.
- **[security.md](../quality/security.md)** : retirer le bloc « Pages d'origine » ;
  ajouter une section **DevSecOps** ; clarifier le cheminement « Audit récurrent →
  Procédure d'urgence » ; définir **SLA**.
- **[workflow.md](../collaboration/workflow.md)** : ajouter une section **fork** pour
  les contributeurs externes sans accès en écriture.
- **[ADR 0005](../decisions/0005-effect-pour-la-pf.md)** : documenter le fait de
...
- **[ADR 0019](../decisions/0019-derogations-workspace-audit.md)** : note explicative
  renvoyant les mentions « Phase X.Y » au plan de résorption (références historiques
  conservées).
- **[glossary.md](../glossary.md)** : ajouter Git, fork, Docker, cache, lint,
...
- **But.** [index.md](../index.md) repensée avec deux entrées claires : « Je
