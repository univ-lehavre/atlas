...
- Les items « Reporté sine die » sont cadrés par [ADR 0001](../decisions/0001-devsecops-perimetre-repo-sine-die.md) et resteront sine die. Le plan les sort juste de TODO.md (ils restent dans l'ADR).
