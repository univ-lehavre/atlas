...
1. **Rotation immédiate** côté émetteur (REDCap, Appwrite Console,
   OpenAlex, GitHub PAT, npm token…) — cf. [`docs/security/secrets.md`](secrets.md)
...
| **Divulgation responsable externe**            | `redcap-support@univ-lehavre.fr` ou [GitHub PVR](https://github.com/univ-lehavre/atlas/security/advisories/new) | Documenté dans [SECURITY.md](../../SECURITY.md)                        |
...
(cf. [packages/auth/src/](../../packages/auth/src/)). Les événements à
...
| **SBOMs historiques**                                         | Artefacts GitHub Actions (90j)                                             | Snapshots manuels dans [docs/security/sbom/](sbom/README.md) |
