#!/usr/bin/env -S tsx
/**
 * Seeds the amarre REDCap project with realistic synthetic records.
 *
 * Strategy
 * --------
 ...
 * subset — enough for the amarre dictionary (118 fields).
 *
 ...
 * what the amarre dictionary uses.
 */
...
const main = async (): Promise<void> => {
  ...
  console.log(
    `\nDone. ${records.length} records seeded into the amarre project.`,
  );
};
