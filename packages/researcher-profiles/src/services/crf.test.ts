...
describe("fetchResearchers", () => {
  ...
  it("wraps fetch errors as CrfFetchError", async () => {
...
describe("writeResearcherData", () => {
  ...
  it("wraps file-import errors as CrfWriteError", async () => {
...
describe("writeFinalReferences", () => {
  ...
  it("wraps PDF generation failures as CrfWriteError", async () => {
  ...
  it("wraps a failed oa_data import as CrfWriteError", async () => {
  ...
  it("wraps a failed oa_pdf import as CrfWriteError", async () => {
    mocks.generateCombinedPdf.mockResolvedValue(new Uint8Array([1]));
    mocks.importFile
  ...
  it("wraps a failed importRecords as CrfWriteError", async () => {
    mocks.generateCombinedPdf.mockResolvedValue(new Uint8Array([1]));
    mocks.importFile.mockReturnValue(Effect.void);
