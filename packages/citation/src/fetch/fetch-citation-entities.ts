...
> =>
  Effect.gen(function* () {
    ...
    const url = new URL(`${citation_api_url}/authors`);
    const params: Query = {
      search,
      per_page,
    };
    const response: CitationResponse<AuthorsSearchResult> =
