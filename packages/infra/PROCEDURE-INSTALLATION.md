...
**Total estimé** : 10-12GB RAM, 4 CPU cores
...
## PHASE 12 : Tests et passage en production
...
# Attendu : auth, office, chat, redcap, ecrin avec ADDRESS
...
for domain in auth office chat redcap ecrin; do
...
## PHASE 13 : Configuration post-installation
...
## PHASE 14 : Gestion des autorisations
...
## PHASE 15 : Sécurité réseau avec Cilium
...
for ns in mattermost authelia onlyoffice redcap ecrin; do
cat <<EOF | kubectl apply -f -
...
## PHASE 16 : Hubble UI (Observabilité réseau)
...
hubble observe --namespace rocketchat
...
**Document basé sur l'installation du 29 janvier 2026**
