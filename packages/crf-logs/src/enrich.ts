import type { LogActionCategory, LogUserType, CrfLogEntry } from "./types.js";
...
const toEntry = (raw: RawLog): CrfLogEntry | null => {
...
const dedupeKey = (e: CrfLogEntry): string =>
  `${String(e.project_id)}|${String(e.timestamp.getTime())}|${e.username}|${e.action}`;

export const enrichLogs = (raw: readonly RawLog[]): CrfLogEntry[] => {
