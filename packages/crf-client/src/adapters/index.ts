...
import type { CrfAdapter } from './types.js';
import { v14Adapter } from './v14.js';
import { v15Adapter } from './v15.js';
import { v16Adapter } from './v16.js';

// Re-export types
export type { CrfAdapter, CrfFeatures, TransformedParams } from './types.js';
 ...
 */
const adapters: readonly CrfAdapter[] = [v14Adapter, v15Adapter, v16Adapter];

/**
 * Find an adapter for a specific version (returns Option).
 */
const findAdapter = (version: Version): Option.Option<CrfAdapter> =>
...
export const getAdapterEffect = (
  version: Version
): Effect.Effect<CrfAdapter, UnsupportedVersionError> =>
  pipe(
    findAdapter(version),
 ...
 */
export const getAdapter = (version: Version): CrfAdapter | undefined =>
 ...
 */
export const getLatestAdapter = (): Option.Option<CrfAdapter> =>
