 ...
 *
 * Re-exports from @univ-lehavre/atlas-crf-core with CRF-specific additions.
 */
...
// Type-only exports
export type { BooleanFlag } from '@univ-lehavre/atlas-crf-core/brands';
 ...
 */
export type CrfUrl = SafeApiUrl;
export const CrfUrl = SafeApiUrl;
