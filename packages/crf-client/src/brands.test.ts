...
describe('Branded Types', () => {
  describe('CrfToken', () => {
    ...
    it('should reject token with wrong length (too long)', () => {
      expect(() => CrfToken('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABB')).toThrow();
    });

    it('should reject token with invalid characters', () => {
      expect(() => CrfToken('GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG')).toThrow();
      expect(() => CrfToken('AAAAAAAAAAAAAAAA!@#$%^&*()AAAAAA')).toThrow();
    });
