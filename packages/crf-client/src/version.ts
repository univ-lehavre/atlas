...
export type { Version, VersionRange } from '@univ-lehavre/atlas-crf-core/version';
...
export {
  ...
  parseVersion,
  tryParseVersion,
} from '@univ-lehavre/atlas-crf-core/version';
...
export { VersionParseError, UnsupportedVersionError } from '@univ-lehavre/atlas-crf-core/errors';

// Backward compatibility aliases
export { LATEST_KNOWN_VERSION as MAX_SUPPORTED_VERSION } from '@univ-lehavre/atlas-crf-core/version';
