...
export class CrfNetworkError extends Data.TaggedError('CrfNetworkError')<{
...
export const fromException = (error: unknown, url?: string): CrfNetworkError =>
  new CrfNetworkError({ cause: error, url });
