...
export const ADAPTERS: readonly CrfAdapter[] = [v16Adapter, v15Adapter, v14Adapter];
 ...
 * ```
 */
export const selectAdapter = (version: Version): Option.Option<CrfAdapter> => {
 ...
 * ```
 */
export const getAdapterByName = (name: string): Option.Option<CrfAdapter> => {
 ...
 */
export const getLatestAdapter = (): CrfAdapter => v16Adapter;
