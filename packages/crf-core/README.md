...
```typescript
import { RecordId, ProjectId } from '@univ-lehavre/atlas-crf-core/brands';
import { CrfError } from '@univ-lehavre/atlas-crf-core/errors';
import { parseVersion } from '@univ-lehavre/atlas-crf-core/version';
```
...
```bash
pnpm -F @univ-lehavre/atlas-crf-core dev        # Development
pnpm -F @univ-lehavre/atlas-crf-core build      # Build
pnpm -F @univ-lehavre/atlas-crf-core test       # Tests
pnpm -F @univ-lehavre/atlas-crf-core typecheck  # Type checking
pnpm -F @univ-lehavre/atlas-crf-core lint       # ESLint
```

## Documentation

- [API Documentation](/atlas/api/univ-lehavre/atlas-crf-core/)
