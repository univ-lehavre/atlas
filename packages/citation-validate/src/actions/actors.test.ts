...
const citationId = "https://openalex.org/A123" as unknown as CitationID;
...
describe("actors", () => {
  beforeEach(() => {
    ...
    mocks.getCitationIDs.mockReturnValue([citationId]);
    ...
    mocks.searchWorksByORCID.mockReturnValue(
      Effect.succeed([
        ...
        makeWork({
          authorships: [
            {
              author: { id: citationId, orcid: "other" },
