 ...
 */
const testVersion = async (client: CrfClient): Promise<TestResult> => {
  try {
 ...
 */
const testProjectInfo = async (client: CrfClient): Promise<TestResult> => {
  try {
    const { result, latencyMs } = await measureLatency(() =>
 ...
 */
const testInstruments = async (client: CrfClient): Promise<TestResult> => {
  try {
    const { result, latencyMs } = await measureLatency(() =>
 ...
 */
const testFields = async (client: CrfClient): Promise<TestResult> => {
  try {
 ...
 */
const testRecords = async (client: CrfClient): Promise<TestResult> => {
  try {
    const { result, latencyMs } = await measureLatency(() =>
...
export const runTests = async (config: TestConfig): Promise<ExitCode> => {
  ...
  let client: CrfClient;
  try {
    client = createCrfClient({
      url: CrfUrl(url),
