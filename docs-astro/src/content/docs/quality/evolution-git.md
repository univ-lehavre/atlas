...
vérifiées à jour en CI (classe A de l'[ADR 0032](../decisions/0032-kpi-determinisme-vs-snapshot)).
...
> ailleurs — cf. [tableau de bord](./tableau-de-bord)).
...
> (esprit de l'[ADR 0032](../decisions/0032-kpi-determinisme-vs-snapshot)).
