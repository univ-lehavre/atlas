...
occurrence, ou pointé vers le [glossaire](../glossary) qui regroupe les
...
→ [ADR 0013 — Documentation pour public non-expert, en français](../decisions/0013-documentation-public-non-expert-fr)
...
profondeur ([docs/quality/tests.md](tests)) ; un test qui s'en écarte
...
→ [ADR 0025 — Documentation à plusieurs niveaux (surface, profondeur, inline)](../decisions/0025-documentation-multi-niveaux)
...
→ [ADR 0012 — Neutralisation du framing institutionnel](../decisions/0012-neutralisation-framing-institutionnel)
...
| --------------------------------------------------------------- | ------------------------ |
| [0012](../decisions/0012-neutralisation-framing-institutionnel) | Ton et framing           |
| [0013](../decisions/0013-documentation-public-non-expert-fr)    | Langue et public         |
| [0025](../decisions/0025-documentation-multi-niveaux)           | Niveaux de documentation |
