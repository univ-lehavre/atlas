{#
  ...
  Défaut : s3://pageviews/curated/<model>/dt=…/run=…/part.parquet
  ...
  `curated_root` est une var (défaut `s3://pageviews/curated`) : le smoke hermétique
...
{{ return(
    var("curated_root", "s3://pageviews/curated") ~ "/" ~ model_name
    ~ "/dt=" ~ var("curated_dt")
