...
describe('atlas-dashboard hooks.server.ts handle', () => {
  ...
  it('wires the shared CSP helper in svelte.config.js (Phase 9.2)', () => {
    ...
    // Ensure the file goes through `kit.csp.directives` and not a custom
    // override that would silently drop our helper.
